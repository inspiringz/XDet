    ...
    <table width="887" border="1">
      <tr>
        <td height="50" colspan="3"><div align="center"><span class="style6">By BLaSTER</span><br />
          ...
          <br />
        <a href="<?=$_SERVER['PHP_SELF']?>">sayfayi tekrar a</a></div></td>
      </tr>
      <tr>
...
?>
        ...
        <td width="308" valign="top" bordercolor="#FFFFFF"><form action="" method="post" name="form2" id="form2">
          <p>
            <label></label>
            <label><strong>Hex evirici <br />
            <br />
            <input name="hex" type="text" id="hex" size="40" />
            </strong></label>
            <strong>
            <input name="submit2" type="submit" id="submit2" value="evir" />
            <br />
            <?PHP
...
echo '0x'.bin2hex($hex);
  ...
  ?>
            ...
            <form action="" method="post" name="form3" id="form3">
              ...
              <label>
                <input name="submit3" type="submit" id="submit3" value="Gster" />
              </label>
              <div align="left">
                <?PHP
...
echo'<br> <a href="http://www.bing.com/search?q=ip%3A'.$adres.'+&go=&form=QBLH&filt=all" target="_blank">Bing arama sayfasini a</a>';
}
?>
              </div>
            </form>
...
?>
        ...
        <td width="275" height="100" valign="top" bordercolor="#FFFFFF"><form id="form7" name="form7" method="post" action="">
          ...
          <p>Gnderen email:
            ...
            <br />
            <input name="submit62" type="submit" id="submit62" value="Gnder" />
            <br />
            <?PHP
$kim=$_POST['kim'];
$kime=$_POST['kime'];
...
?>
  ...
  "Hakim beye syledik, biz sua meyilli insanlariz.."</p>
